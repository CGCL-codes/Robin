...
import logging
from explainer_robin_embmask import TBCNN_explainer
...
def main(train_opt, test_opt):
    ...
    train_opt.model_path = os.path.join("../model", util_functions.form_tbcnn_model_path(train_opt))
    ...
    with tf.control_dependencies(update_ops):
        ...
        neg_training_point = optimizer.minimize(tbcnn_model.neg_loss, var_list = tbcnn_model.neg_var_list)
